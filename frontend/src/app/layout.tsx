    ...
    >
      <body className="min-h-screen flex flex-col relative bg-background text-foreground antialiased selection:bg-moody-blue-500/30 selection:text-moody-blue-200">
        ...
        <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
          ...
          <div className="absolute -top-24 left-1/4 w-120 h-120 rounded-full bg-moody-blue-500/12 dark:bg-moody-blue-500/20 blur-[100px]" />
          <div className="absolute top-1/3 -right-20 w-105 h-105 rounded-full bg-moody-blue-700/10 dark:bg-moody-blue-700/18 blur-[100px]" />
          <div className="absolute -bottom-24 left-1/3 w-115 h-115 rounded-full bg-moody-blue-600/8 dark:bg-moody-blue-600/15 blur-[120px]" />
        </div>
