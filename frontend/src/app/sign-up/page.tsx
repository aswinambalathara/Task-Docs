...
import { FileText, ArrowRight, ShieldCheck, Check, Sparkles } from "lucide-react"
    ...
    <div className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center overflow-hidden px-3.5 py-8 sm:px-4 sm:py-12">
      ...
      >
        <Card className="glass-panel border-border/80 shadow-moody-blue-900/5 space-y-6 rounded-3xl border p-6 shadow-2xl backdrop-blur-xl sm:p-8 dark:shadow-black/40">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-muted-foreground text-xs">
                      Sync commits & IDE sessions directly
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-muted-foreground text-xs">Seamless sync with Google Docs</p>
                  </div>
                </div>
                <ArrowRight className="text-muted-foreground group-hover:text-foreground h-4 w-4 transition-all group-hover:translate-x-0.5" />
              </Button>
          ...
          <div className="bg-muted/40 dark:bg-muted/20 border-border/50 space-y-2 rounded-xl border p-3.5">
            <div className="text-foreground flex items-center gap-1.5 text-xs font-semibold tracking-tight">
              <Sparkles className="text-moody-blue-600 dark:text-moody-blue-400 h-3.5 w-3.5" />
