        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-3.5 right-3.5 z-20 text-muted-foreground hover:text-foreground cursor-pointer rounded-lg h-7 w-7 p-0"
                size="icon-xs"
              />
            }
          >
